...
declare const getDefaultConfig: () => {
    ...
    readonly classGroups: {
        ...
        /**
         * Mask Clip
         * @see https://tailwindcss.com/docs/maREDACTED
         */
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly ["border", "padding", "content", "fill", "stroke", "view"];
        }, "maREDACTED"];
        /**
         * Mask Composite
         * @see https://tailwindcss.com/docs/maREDACTED
         ...
         */
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly [(value: string) => boolean];
        }];
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly [(value: string) => boolean, (value: string) => boolean, (value: string) => boolean, (value: string) => boolean];
        }];
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly [(value: string) => boolean, (value: string) => boolean, (value: string) => boolean, (value: string) => boolean];
        }];
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly [ThemeGetter, (value: string) => boolean, (value: string) => boolean];
        }];
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly [ThemeGetter, (value: string) => boolean, (value: string) => boolean];
        }];
        ...
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly [(value: string) => boolean, (value: string) => boolean];
        }];
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly [(value: string) => boolean, (value: string) => boolean, (value: string) => boolean, (value: string) => boolean];
        }];
        ...
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly ["circle", "ellipse"];
        }];
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly [{
        ...
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly ["center", "top", "bottom", "left", "right", "top-left", "left-top", "top-right", "right-top", "bottom-right", "right-bottom", "bottom-left", "left-bottom"];
        }];
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly [(value: string) => boolean];
        }];
         ...
         */
        readonly 'maREDACTED': readonly [{
            readonly 'maREDACTED': readonly ["alpha", "luminance"];
        }];
        /**
         * Mask Image
         * @see https://tailwindcss.com/docs/maREDACTED
