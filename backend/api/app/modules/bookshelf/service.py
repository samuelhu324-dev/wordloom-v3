...
from modules.bookshelf.domain import Bookshelf, BookshelfStatus
from modules.bookshelf.repository import BookshelfRepository
...
class BookshelfService:
    ...
    async def set_description(self, bookshelf_id: UUID, description: str = None) -> Bookshelf:
        ...
        from modules.bookshelf.domain import BookshelfDescription
        bookshelf = await self.get_bookshelf(bookshelf_id)
