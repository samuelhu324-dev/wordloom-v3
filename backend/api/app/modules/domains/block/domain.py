...
class BlockTitle(ValueObject):
    """
    DEPRECATED: Use BlockType (HEADING_1, HEADING_2, HEADING_3) instead.

    Value object for Block title with hierarchy level.
    Kept for backward compatibility or future enhancements (e.g., subtitle support).

    Design Note (2025-11-11):
    - HEADING_1-3 are now explicit BlockType values
    - title field can be used for optional "secondary title" or metadata
    - For heading hierarchy, use block_type and content directly
    """
