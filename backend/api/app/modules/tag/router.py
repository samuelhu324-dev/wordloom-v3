...
========================================
- Dependency injection chain: FastAPI → router → service → repository → domain
- Exception handling with HTTP status code mapping
- Request/response validation with Pydantic schemas
- Structured logging for debugging
- Documentation and examples for each endpoint
...
- GET /tags - List tags (with search/pagination)
- GET /tags/hierarchy - Get hierarchical tag tree
- POST /tags/{id}/associate - Link tag to entity
- DELETE /tags/{id}/associate - Unlink tag from entity
- GET /tags/entity/{type}/{id} - Get tags on entity
"""
